...
public class ProductAdapter2 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter2(Context mtx, List<Product> productList) {
        this.mtx = mtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, final  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf2.class);
