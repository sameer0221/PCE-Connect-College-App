...
public class ProductAdapter13 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter13(Context mtx, List<Product> productList) {
        this.mtx = mtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, final  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf13.class);
...
class ProductViewHolder13 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder13(@NonNull View itemView) {
        super(itemView);
