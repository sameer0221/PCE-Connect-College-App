...
public class ProductAdapter20 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter20(Context mtx, List<Product> productList) {
        this.mtx = mtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, final  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf20.class);
...
class ProductViewHolder20 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder20(@NonNull View itemView) {
        super(itemView);
