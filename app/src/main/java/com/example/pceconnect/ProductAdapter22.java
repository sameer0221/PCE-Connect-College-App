...
public class ProductAdapter22 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter22(Context mtx, List<Product> productList) {
        this.mtx = mtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, final  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf22.class);
...
class ProductViewHolder22 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder22(@NonNull View itemView) {
        super(itemView);
