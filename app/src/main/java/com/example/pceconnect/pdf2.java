...
public class pdf2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isConnected())
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(pdf2.this);
...

    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog = new ProgressDialog(pdf2.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(pdf2.this,MainActivity2.class);
