...
public class pdf16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf16);
        ...
        pdfView = findViewById(R.id.pdfv16);
        ...
        if (isConnected())
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(pdf16.this);
...

    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog = new ProgressDialog(pdf16.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(pdf16.this,MainActivity16.class);
