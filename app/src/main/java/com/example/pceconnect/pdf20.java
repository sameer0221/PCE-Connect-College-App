...
public class pdf20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf20);
        ...
        pdfView = findViewById(R.id.pdfv20);
        ...
        if (isConnected())
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(pdf20.this);
...

    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog = new ProgressDialog(pdf20.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(pdf20.this,MainActivity20.class);
