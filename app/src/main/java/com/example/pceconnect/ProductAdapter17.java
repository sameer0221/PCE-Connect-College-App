...
public class ProductAdapter17 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter17(Context mtx, List<Product> productList) {
        this.mtx = mtx;
       ...
       /* holder.imageView.setImageDrawable(mtx.getResources().getDrawable(product.getImage()));*/
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf17.class);
...
class ProductViewHolder17 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder17(@NonNull View itemView) {
        super(itemView);
