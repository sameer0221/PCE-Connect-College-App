...
public class pdf3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView = findViewById(R.id.pdfv3);
        ...
        if (isConnected())
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(pdf3.this);
...

    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog = new ProgressDialog(pdf3.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(pdf3.this,MainActivity3.class);
