...
public class ProductAdapter6 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter6(Context mtx, List<Product> productList) {
        this.mtx = mtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, final  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf6.class);
...
class ProductViewHolder6 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder6(@NonNull View itemView) {
        super(itemView);
