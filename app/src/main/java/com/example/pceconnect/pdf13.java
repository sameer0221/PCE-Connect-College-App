...
public class pdf13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView = findViewById(R.id.pdfv13);
        ...
        if (isConnected())
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(pdf13.this);
...

    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog = new ProgressDialog(pdf13.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(pdf13.this,MainActivity13.class);
