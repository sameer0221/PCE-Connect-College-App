...
public class pdf21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf21);
        ...
        pdfView = findViewById(R.id.pdfv21);
        ...
        if (isConnected())
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(pdf21.this);
...

    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog = new ProgressDialog(pdf21.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(pdf21.this,MainActivity21.class);
