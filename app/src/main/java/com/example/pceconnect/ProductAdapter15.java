...
public class ProductAdapter15 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter15(Context mtx, List<Product> productList) {
        this.mtx = mtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, final  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf15.class);
...
class ProductViewHolder15 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder15(@NonNull View itemView) {
        super(itemView);
