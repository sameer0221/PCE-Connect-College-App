...
public class ProductAdapter10 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter10(Context mtx, List<Product> productList) {
        this.mtx = mtx;
       ...
       /* holder.imageView.setImageDrawable(mtx.getResources().getDrawable(product.getImage()));*/
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf10.class);
...
class ProductViewHolder10 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder10(@NonNull View itemView) {
        super(itemView);
