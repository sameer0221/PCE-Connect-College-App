...
public class pdf18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf18);
        ...
        pdfView = findViewById(R.id.pdfv18);
        ...
        if (isConnected())
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(pdf18.this);
...

    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog = new ProgressDialog(pdf18.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(pdf18.this,MainActivity18.class);
