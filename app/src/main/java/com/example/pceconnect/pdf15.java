...
public class pdf15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf15);
        ...
        pdfView = findViewById(R.id.pdfv15);
        ...
        if (isConnected())
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(pdf15.this);
...

    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog = new ProgressDialog(pdf15.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(pdf15.this,MainActivity15.class);
