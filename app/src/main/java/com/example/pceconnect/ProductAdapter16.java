...
public class ProductAdapter16 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter16(Context mtx, List<Product> productList) {
        this.mtx = mtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, final  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf16.class);
...
class ProductViewHolder16 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder16(@NonNull View itemView) {
        super(itemView);
