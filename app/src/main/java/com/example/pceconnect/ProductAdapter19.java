...
public class ProductAdapter19 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter19(Context mtx, List<Product> productList) {
        this.mtx = mtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, final  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf19.class);
...
class ProductViewHolder19 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder19(@NonNull View itemView) {
        super(itemView);
