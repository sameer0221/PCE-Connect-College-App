...
public class ProductAdapter21 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter21(Context mtx, List<Product> productList) {
        this.mtx = mtx;
       ...
       /* holder.imageView.setImageDrawable(mtx.getResources().getDrawable(product.getImage()));*/
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf21.class);
...
class ProductViewHolder21 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder21(@NonNull View itemView) {
        super(itemView);
