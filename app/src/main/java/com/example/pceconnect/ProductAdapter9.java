...
public class ProductAdapter9 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter9(Context mtx, List<Product> productList) {
        this.mtx = mtx;
       ...
       /* holder.imageView.setImageDrawable(mtx.getResources().getDrawable(product.getImage()));*/
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf9.class);
...
class ProductViewHolder9 extends RecyclerView.ViewHolder{
   ...
   /* ImageView imageView;*/
    ...
    public ProductViewHolder9(@NonNull View itemView) {
        super(itemView);
