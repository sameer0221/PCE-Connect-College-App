...
public class pdf22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf22);
        ...
        pdfView = findViewById(R.id.pdfv22);
        ...
        if (isConnected())
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(pdf22.this);
...

    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog = new ProgressDialog(pdf22.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(pdf22.this,MainActivity22.class);
