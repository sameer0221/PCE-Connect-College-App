...
public class ProductAdapter7 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter7(Context mtx, List<Product> productList) {
        this.mtx = mtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, final  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf7.class);
...
class ProductViewHolder7 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder7(@NonNull View itemView) {
        super(itemView);
