...
public class pdf19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf19);
        ...
        pdfView = findViewById(R.id.pdfv19);
        ...
        if (isConnected())
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(pdf19.this);
...

    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog = new ProgressDialog(pdf19.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(pdf19.this,MainActivity19.class);
