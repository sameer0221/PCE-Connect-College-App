...
public class pdf4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView = findViewById(R.id.pdfv4);
        ...
        if (isConnected())
        {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(pdf4.this);
...

    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog = new ProgressDialog(pdf4.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(pdf4.this,MainActivity4.class);
