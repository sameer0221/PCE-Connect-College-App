...
public class ProductAdapter5 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter5(Context mtx, List<Product> productList) {
        this.mtx = mtx;
       ...
       /* holder.imageView.setImageDrawable(mtx.getResources().getDrawable(product.getImage()));*/
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf5.class);
