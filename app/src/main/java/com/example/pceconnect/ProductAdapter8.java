...
public class ProductAdapter8 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter8(Context mtx, List<Product> productList) {
        this.mtx = mtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, final  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf8.class);
...
class ProductViewHolder8 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder8(@NonNull View itemView) {
        super(itemView);
