...
public class ProductAdapter18 extends RecyclerView.Adapter<ProductViewHolder> implements Filterable {
    ...
    public ProductAdapter18(Context mtx, List<Product> productList) {
        this.mtx = mtx;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, final  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(),pdf18.class);
...
class ProductViewHolder18 extends RecyclerView.ViewHolder{
    ...
    public ProductViewHolder18(@NonNull View itemView) {
        super(itemView);
